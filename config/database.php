    ...
    */
    ...
    'connections' => [
        ...
        'admin' => [
            ...
            'database' => env('ADMIN_DB_DATABASE', 'laravel'),
            ...
            'collation' => env('ADMIN_DB_COLLATION', 'utf8mb4_general_ci'),
        ...
        'api' => [
            ...
            'collation' => env('API_DB_COLLATION', 'utf8mb4_general_ci'),
            'prefix' => env('API_DB_PREFIX', ''),
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
    ...
    */
    ...
    'redis' => [
        ...
        'admin_cache' => [
            ...
            'password' => env('REDIS_PASSWORD'),
            'port' => env('REDIS_PORT', '6379'),
            'prefix' => env('ADMIN_CACHE_PREFIX', ''),
            'database' => env('ADMIN_CACHE_DB',11),
        ],
        ...
        'admin_queue' => [
            ...
            'port' => env('REDIS_PORT', '6379'),
            'prefix' => env('ADMIN_CACHE_PREFIX',''),
            'database' => env('ADMIN_QUEUE_DB', 10),
        ],
    ],
];
