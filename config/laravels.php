...
//        [
//            'host'     => '0.0.0.0',
//            'port'     => env('LARAVELS_WEBSOCKET_PORT', 5201),
...
//        ],
    ...
    */
    ...
    'timer' => [
        ...
        'jobs'            => [
            \App\Jobs\Admin\CheckTokenExpiration::class
    ...
    */
    ...
    'swoole_tables' => [
        'ws' => [
            'size'   => 102400,
            'column' => [
                ['name' => 'uid', 'type' => \Swoole\Table::TYPE_INT, 'size' => 8],
                ['name' => 'token_id', 'type' => \Swoole\Table::TYPE_INT, 'size' => 8],
                ['name' => 'token_value', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 64],
            ]
        ]
    ],
    ...
    */
    ...
    'swoole' => [
        ...
        'pid_file'           => storage_path('laravels/laravels.pid'),
        'log_level'          => env('LARAVELS_LOG_LEVEL', 4),
        'log_file'           => storage_path('laravels/'.sprintf('logs/swoole-%s.log', date('Y-m'))),
